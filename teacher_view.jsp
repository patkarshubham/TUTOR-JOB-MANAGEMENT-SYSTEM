<%-- 
    Document   : contactus
    Created on : Mar 25, 2020, 1:26:35 AM
...
<div class="row" style="float: right;width:75%;">
        ...
        <%
               DbManager db=new DbManager();
                String q=" select Name,Qualifications,Bio,TeacherId from teacher";
      ...
      <div class="container">
          <h2 style="font-family: monospace;font-size: 32px;color: orange;"><%=rs.getString(1)%></h2>
          <p class="title" style="color: black;font-size: 22px;">"<%=rs.getString(2)%>"</p>
           <p style="color: black;font-size: 20px;"><%=rs.getString(3)%></p>
           <a href="teacherdetail.jsp?Id=<%=rs.getString(4)%>"><p><input type="Submit" class="button" value="More Info."/></p></a>
      </div>
